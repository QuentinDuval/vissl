...
- `create_clevr_dist_data_files.py`: to create a dataset from [CLEVR](https://arxiv.org/abs/1612.068901) where the goal is to estimate the distance of the closest object in the scene
