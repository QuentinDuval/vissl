...
def create_imagenet_a_test_files(input_path: str, output_path: str):
    """
    Create a test split for ImageNet, based on the ImageNet-R dataset
    """

    # Map the images of Imagenet-A to their corresponding targets in Imagenet
    image_paths = []
    image_labels = []
...
if __name__ == "__main__":
    ...
    create_imagenet_a_test_files(input_path=input_path, output_path=args.output)
